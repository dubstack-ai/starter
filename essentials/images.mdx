...
<Gallery>
  <GalleryItem src="/images/hero-light.png" alt="Starter homepage hero in light mode" />
  <GalleryItem src="/images/hero-dark.png" alt="Starter homepage hero in dark mode" />
