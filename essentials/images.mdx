...
```markdown
![Documentation checks completed successfully](/images/checks-passed.png)
```
...
<img
  ...
  alt="Documentation checks completed successfully"
...
<Frame caption="A successful documentation validation run">
  <img src="/images/checks-passed.png" alt="Documentation checks completed successfully" />
</Frame>
...
```markdown
![Feature demonstration](/path/demo.gif)
```
